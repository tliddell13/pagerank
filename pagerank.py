...
def sample_pagerank(corpus, damping_factor, n):
    ...
    for _ in range(n):
        if sample:
            # if there is a previous sample available choose using transition model
